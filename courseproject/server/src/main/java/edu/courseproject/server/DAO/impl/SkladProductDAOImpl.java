...
public class SkladProductDAOImpl implements SkladProductDAO {
    ...
    private final static String FIND_SUPPLIERS_IN_SKLAD="select logist.sklad_product.product_idproduct as idproduct , SUM(logist.sklad_product.quantity) as amount " +
            "from logist.sklad_product "  +
            "where logist.sklad_product.sklad_idsklad in (select logist.order.sklad_idsklad from logist.order where logist.order.idorder = ?) " +
            "group by logist.sklad_product.product_idproduct " +
            "order by logist.sklad_product.product_idproduct asc";

...
public class SkladDAOImpl implements SkladDAO {
    ...
    private final static String FIND_BY_ID ="select * from logist.sklad where idsklad in (select logist.order.sklad_idsklad from logist.order where logist.order.idorder = ?)";

...
public class AdminStaffPageController implements Initializable {
    ...
    @FXML
    private TextField searchSurnameId;
    ...
    @FXML
    void searchWorkerInBD(ActionEvent event) {

        JSONObject jsonObject = new JSONObject();
        jsonObject.put("action", Action.SEARCH_WORKER);
        jsonObject.put("param", searchSurnameId.getText());
